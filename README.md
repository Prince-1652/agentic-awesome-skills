<!-- registry-sync: version=11.3.0; skills=1461; stars=37665; updated_at=2026-05-16T07:52:13+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,461+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,461+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,461+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,461+ Skills](#browse-1461-skills)
...
If you want a faster answer than "browse all 1,461+ skills", start with a tool-specific guide:
