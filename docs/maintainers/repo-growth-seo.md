...
> Installable GitHub library of 1,461+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.
...
- use a clean preview image that says `1,461+ Agentic Skills`;
