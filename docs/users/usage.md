...
✅ **Downloaded 1,461+ skill files** to your computer (default: `~/.gemini/antigravity/skills/`; or a custom path like `~/.agent/skills/` if you used `--path`)
...
- You installed a toolbox with 1,461+ tools (✅ done)
...
Don't try to use all 1,461+ skills at once. Here's a sensible approach:
...
No. Even though you have 1,461+ skills installed locally, you should **not** concatenate every `SKILL.md` into a single system prompt or context block.
